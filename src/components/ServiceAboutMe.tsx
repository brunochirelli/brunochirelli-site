...
const ServiceAboutMe = () => (
  <Container maxWidth="md" style={{ margin: "4rem auto", textAlign: "center" }}>
    <Box>
      <Avatar
        style={{
          width: "250px",
    ...
    <Box marginY="1.5rem">
      <Typography paragraph>
        Publicitário de formação, desenvolvedor e designer com mais de 10 anos de
        experiência em design de marcas, especialista em marketing para mecanismos de
        busca certificado pelas empresas líderes de mercado.
      </Typography>
    </Box>
